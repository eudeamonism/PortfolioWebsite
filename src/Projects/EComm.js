    ...
    <Container minW={'400px'} maxW='container.xl'>
      <Box borderWidth={"1px"} p={{ base: "1em", md: "1.5em", lg: "2em" }} mt="-1" >
        ...
        <Text color={"#1B4F8C"} fontSize={{ base: "sm", md: "md", lg: "lg" }}>
          ...
          gateways, and administrator privileges. The site is secure and uses a variety of server
          and client-side security measures to protect user data. The site is also responsive and
