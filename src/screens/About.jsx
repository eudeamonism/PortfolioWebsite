              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    Chakra UI. Additionally, I created user and administrator login accounts where
                    the administrator has editing privileges such that he can add or remove users
                    and products while the user can add and remove products and update his
                    credentials.
                  </td>
                  <td>21 hours</td>
                  <td>60 hours+</td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    ways of state management, such as props and Redux, while creating CRUD APIs with
                    NodeJS and housing data in MongoDB.
                  </td>
                  <td>19 hours</td>
                  <td>50 hours+</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    created a RESTful API with CRUD operations, and I added filters and pagination.
                    I implemented authentication and authorization, including password reset. I
                    learned about security, encryption, and sanitization, and I implemented these
                    concepts in my application, which was a tourist retreat website.
                  </td>
                  <td>35 hours</td>
                  <td>70 hours+</td>
                </tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    final construction, with a focus on medical building renovations. I used
                ...
                <tr>
                  ...
                  <td>
                    ...
                    blueprints for various mini-mansion homes. I used my design and drafting skills
                    to create a cohesive brand identity for the firm, and to help clients visualize
                    their dream homes.
                  </td>
                  <td>2009</td>
                </tr>
